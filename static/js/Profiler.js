...
*/
    ...
    function _updateInfoboxSpec() {
        ...
        Icon.setTinyBg(spSpec, g_file_specs[_profile.classs][specData.id - 1] ?? g_file_specs[specData.id]);
    ...
    function _updateBuild(build) {
        ...
        if (_mode == 'pets') {
            ...
            if (sp) {
                ...
                Icon.setTinyBg(sp, g_file_specs[_profile.classs][specData.id - 1] ?? g_file_specs[specData.id]);
