...
// *************************************************************
    ...
    function _createTrees(classId) {
        ...
        for (var tree = 0; tree < _nTrees; ++tree) {
            ...
            // background art is stored at native resolution (no resizing) - CSS scales it to the intended display box
            if (_mode == MODE_PET) {
                d.style.backgroundImage = 'url(' + g_staticUrl + '/images/wow/hunterpettalents/bg_' + (c[0].i + 1) + '.png' + afterUrl + ')';
                d.style.backgroundSize = '244px 364px';
            }
            else {
                d.style.backgroundImage = 'url(' + g_staticUrl + '/images/wow/talents/backgrounds/' + g_file_classes[classId] + '_' + (tree + 1) + '.png' + afterUrl + ')';
