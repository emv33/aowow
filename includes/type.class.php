...
abstract class Type
{
    ...
    public const int ITEMSET =                      4;
    public const int QUEST =                        5;
    public const int SPELL =                        6;
    public const int ZONE =                         7;
    public const int FACTION =                      8;
    public const int PET =                          9;
    public const int ACHIEVEMENT =                 10;
    public const int TITLE =                       11;
    public const int WORLDEVENT =                  12;
    public const int CHR_CLASS =                   13;
    public const int CHR_RACE =                    14;
    public const int SKILL =                       15;
    public const int STATISTIC =                   16;
    public const int CURRENCY =                    17;
    //               PROJECT =                     18;
    public const int SOUND =                       19;
    //               BUILDING =                    20;
    //               FOLLOWER =                    21;
    //               MISSION_ABILITY =             22;
    //               MISSION =                     23;
    ...
    // our own things
    public const int GUILD =                      101;
    //               TRANSMOG_SET =               101;      // future conflict inc.
    public const int ARENA_TEAM =                 102;
    //               OUTFIT =                     110;
    //               GEAR_SET =                   111;
    ...
    public const int GUIDE =                      300;      // should have been 100, but conflicts with old version of Profile/List
    public const int USER =                       500;
    public const int EMOTE =                      501;
    ...
    public const int FLAG_RANDOM_SEARCHABLE = 0x1;
    public const int FLAG_FILTRABLE         = 0x2;
