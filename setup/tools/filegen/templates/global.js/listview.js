    ...
    requires:
    {
        ...
        compute: function(item, td)
        {
            if (item.achievement && g_achievements[item.achievement])
            {
                ...
                a.style.backgroundImage = 'url(' + Icon.url(g_achievements[item.achievement].icon) + ')';
    ...
    appendMoney: function(d, money, side, costItems, costCurrency, achievementPoints)
    {
        ...
        if (costItems != null)
        {
            for (var i = 0; i < costItems.length; ++i)
            {
                ...
                _.style.backgroundImage = 'url(' + Icon.url(icon) + ')';
                $WH.ae(_, $WH.ct(count));
                $WH.ae(d, _);
            }
        }
...
//  aowow: replacement
                ...
                else                                        // tokens
                {
                    ...
                    _.style.backgroundImage = 'url(' + Icon.url(icon[0]) + ')';
