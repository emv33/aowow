...
CREATE TABLE `aowow_itemenchantment` (
  ...
  `itemVisualId` smallint unsigned NOT NULL,
...
CREATE TABLE `aowow_items` (
  ...
  `itemVisualId` smallint unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `aowow_itemset` (
  ...
  `minReqLevel` tinyint(3) NOT NULL DEFAULT 0,
  `maxReqLevel` tinyint(3) NOT NULL DEFAULT 0,
...
CREATE TABLE `aowow_spell` (
  ...
  `stanceMask` int(11) unsigned NOT NULL,
  `stanceMaskNot` int(11) unsigned NOT NULL,
  `targets` mediumint(8) unsigned NOT NULL,
  `spellFocusObject` smallint(5) unsigned NOT NULL,
  `casterAuraSpell` mediumint(8) unsigned NOT NULL,
  `targetAuraSpell` mediumint(8) unsigned NOT NULL,
  `casterAuraSpellNot` mediumint(8) unsigned NOT NULL,
  `targetAuraSpellNot` mediumint(8) unsigned NOT NULL,
  ...
  `effect1SpellClassMaskA` int(11) unsigned NOT NULL,
  `effect1SpellClassMaskB` int(11) unsigned NOT NULL,
  `effect1SpellClassMaskC` int(11) unsigned NOT NULL,
  `effect2SpellClassMaskA` int(11) unsigned NOT NULL,
  `effect2SpellClassMaskB` int(11) unsigned NOT NULL,
  `effect2SpellClassMaskC` int(11) unsigned NOT NULL,
  `effect3SpellClassMaskA` int(11) unsigned NOT NULL,
  `effect3SpellClassMaskB` int(11) unsigned NOT NULL,
  `effect3SpellClassMaskC` int(11) unsigned NOT NULL,
  ...
  `spellFamilyFlags1` int(11) unsigned NOT NULL,
  `spellFamilyFlags2` int(11) unsigned NOT NULL,
  `spellFamilyFlags3` int(11) unsigned NOT NULL,
