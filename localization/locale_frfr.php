...
//      'noTarget'      => "Vers les autres sans cible",
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Cet sort sera converti en <a href="?spell=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> si vous transférez en <span class="icon-%5$s">%6$s</span>.',
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Coût",
        'content'       => "Contenu",
        '_transfer'     => 'Cet objet sera converti en <a href="?item=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> si vous transférez en <span class="icon-%5$s">%6$s</span>.',
