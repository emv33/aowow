...
//      'noTarget'      => "Vers les autres sans cible",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'Cet haut fait sera converti en <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si vous transférez en <span class="icon-%s">%s</span>.',
        'cat'           => array(
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Cet sort sera converti en <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si vous transférez en <span class="icon-%s">%s</span>.',
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Coût",
        'content'       => "Contenu",
        '_transfer'     => 'Cet objet sera converti en <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si vous transférez en <span class="icon-%s">%s</span>.',
