...
//      'noTarget'      => "An Andere ohne Ziel",
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Dieser Zauber wird mit <a href="?spell=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> vertauscht, wenn Ihr zur <span class="icon-%5$s">%6$s</span> wechselt.',
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Preis",
        'content'       => "Inhalt",
        '_transfer'     => 'Dieser Gegenstand wird mit <a href="?item=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> vertauscht, wenn Ihr zur <span class="icon-%5$s">%6$s</span> wechselt.',
