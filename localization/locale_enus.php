...
//      'noTarget'      => "To others without a target",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'This achievement will be converted to <a href="?achievement=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> if you transfer to <span class="icon-%5$s">%6$s</span>.',
        'cat'           => array(
    ...
    'spell' => array(
        ...
        '_transfer'     => 'This spell will be converted to <a href="?spell=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> if you transfer to <span class="icon-%5$s">%6$s</span>.',
...
/* -316*/   "Underwater Walking",                   "Periodic Haste"
    ...
    'item' => array(
        ...
        'content'       => "Content",
        '_transfer'     => 'This item will be converted to <a href="?item=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a> if you transfer to <span class="icon-%5$s">%6$s</span>.',
