...
$lang = array(
    ...
    'game' => array(
        ...
        'copper'        => "%d Copper",                     // COPPER_AMOUNT
        'silver'        => "%d Silver",                     // SILVER_AMOUNT
        'gold'          => "%d Gold",                       // GOLD_AMOUNT

        'pvp'           => "PvP",                           // PVP
        'honorPoints'   => "Honor Points",                  // HONOR_POINTS
        'arenaPoints'   => "Arena Points",                  // ARENA_POINTS
        'acvmtPoints'   => "Achievement Points",            // ACHIEVEMENT_TITLE
        ...
        'pvpSources'    => array(
             42 => "Arena Season 1",         62 => "Arena Season 2",         71 => "Arena Season 3",         80 => "Arena Season 4",        157 => "Arena Season 5",
            167 => "Arena Season 6",        169 => "Arena Season 7",        177 => "Arena Season 8",        163 => "2009 Arena Tournament"
        ),
...
/* 60*/     SmartEvent::EVENT_UPDATE                  => ['(%11$s)?After %11$s:Instantly;', 'Repeat every %s'],
            ...
            SmartEvent::EVENT_GOSSIP_SELECT           => ['Selecting Gossip Option:[br][url=?gossip=%1$d](%11$s)?[span class="%12$s"]%11$s[/span]:Menu #[b]%1$d[/b] - Option #[b]%2$d[/b];[/url]', ''],
...
/* 50*/     SmartAction::ACTION_SUMMON_GO                          => ['Summon [object=%1$d](%2$d)? for %11$s:; at #target#.', 'Despawn not linked to summoner'],
            ...
            SmartAction::ACTION_ACTIVATE_TAXI                      => ['[url=?taxipath=%1$d]Fly from [span class=q1]%11$s[/span] to [span class=q1]%12$s[/span][/url]', ''],
            SmartAction::ACTION_WP_START                           => ['(%1$d)?Run:Walk; on [url=?waypointpath=%2$d]waypoint path #%2$d[/url](%4$d)? and be bound to [quest=%4$d]:;.(%5$d)? Despawn after %11$s:;', 'Repeatable(%12$s)? [DEPRECATED] React %12$s on path:;'],
...
/* 90*/     SmartAction::ACTION_SET_UNIT_FIELD_BYTES_1             => ['Set UnitFieldBytes1 %11$s for #target#.', ''],
            ...
            SmartAction::ACTION_SEND_GOSSIP_MENU                   => ['Display [url=?gossip=%1$d]Gossip entry #[b]%1$d[/b][/url] / TextID #[b]%2$d[/b].', ''],
...
/*130*/     SmartAction::ACTION_SCENE_CANCEL                       => null,
            SmartAction::ACTION_SPAWN_SPAWNGROUP                   => ['Spawn the group [b]%11$s[/b](%12$s)? [small class=q0]— %12$s[/small]:;%13$s', 'Cooldown: %s'],
            SmartAction::ACTION_DESPAWN_SPAWNGROUP                 => ['Despawn the group [b]%11$s[/b](%12$s)? [small class=q0]— %12$s[/small]:;%13$s', 'Cooldown: %s'],
...
//      'noTarget'      => "To others without a target",
    ...
    'conditionBrowser' => array(
        'srcType'       => "Source type",
        'cndType'       => "Condition type",
        'value1'        => "Condition value",
        'entry'         => "Source group or entry",
        'anySource'     => "Any source type",
        'anyCondition'  => "Any condition type",
        'titleNpc'      => "Conditions: %s",
        'srcTypes'      => array(
            Conditions::SRC_CREATURE_LOOT_TEMPLATE      => "Creature loot",
            Conditions::SRC_DISENCHANT_LOOT_TEMPLATE    => "Disenchant loot",
            Conditions::SRC_FISHING_LOOT_TEMPLATE       => "Fishing loot",
            Conditions::SRC_GAMEOBJECT_LOOT_TEMPLATE    => "Object loot",
            Conditions::SRC_ITEM_LOOT_TEMPLATE          => "Item loot",
            Conditions::SRC_MAIL_LOOT_TEMPLATE          => "Mail loot",
            Conditions::SRC_MILLING_LOOT_TEMPLATE       => "Milling loot",
            Conditions::SRC_PICKPOCKETING_LOOT_TEMPLATE => "Pickpocket loot",
            Conditions::SRC_PROSPECTING_LOOT_TEMPLATE   => "Prospecting loot",
            Conditions::SRC_REFERENCE_LOOT_TEMPLATE     => "Reference loot",
            Conditions::SRC_SKINNING_LOOT_TEMPLATE      => "Skinning loot",
            Conditions::SRC_SPELL_LOOT_TEMPLATE         => "Spell loot",
            Conditions::SRC_SPELL_IMPLICIT_TARGET       => "Spell implicit target",
            Conditions::SRC_GOSSIP_MENU                 => "Gossip menu",
            Conditions::SRC_GOSSIP_MENU_OPTION          => "Gossip menu option",
            Conditions::SRC_CREATURE_TEMPLATE_VEHICLE   => "Vehicle",
            Conditions::SRC_SPELL                       => "Spell",
            Conditions::SRC_SPELL_CLICK_EVENT           => "Spell click event",
            Conditions::SRC_QUEST_AVAILABLE             => "Quest available",
            Conditions::SRC_QUEST_SHOW_MARK             => "Quest marker",
            Conditions::SRC_VEHICLE_SPELL               => "Vehicle spell",
            Conditions::SRC_SMART_EVENT                 => "SmartAI event",
            Conditions::SRC_NPC_VENDOR                  => "Vendor",
            Conditions::SRC_SPELL_PROC                  => "Spell proc",
            Conditions::SRC_AREATRIGGER_CLIENT          => "Areatrigger"
        ),
        'cndTypes'      => array(
             1 => "Aura",                    2 => "Item in inventory",     3 => "Item equipped",
             4 => "Zone",                    5 => "Reputation",            6 => "Team",
             7 => "Skill",                   8 => "Quest rewarded",        9 => "Quest taken",
            10 => "Drunk",                  11 => "World state",          12 => "Active event",
            13 => "Instance info",          14 => "Quest never accepted", 15 => "Class",
            16 => "Race",                   17 => "Achievement",          18 => "Title",
            19 => "Spawn mask",             20 => "Gender",               21 => "Unit state",
            22 => "Map",                    23 => "Area",                 24 => "Creature type",
            25 => "Spell known",            26 => "Phase mask",           27 => "Level",
            28 => "Quest completed",        29 => "Near creature",        30 => "Near gameobject",
            31 => "Object entry or guid",   32 => "Type mask",            33 => "Relation to",
            34 => "Reaction to",            35 => "Distance to",          36 => "Alive",
            37 => "Health value",           38 => "Health percent",       39 => "Realm achievement",
            40 => "In water",               41 => "Terrain swap",         42 => "Stand state",
            43 => "Daily quest done",       44 => "Charmed",              45 => "Pet type",
            46 => "On taxi",                47 => "Quest state",          48 => "Quest objective progress",
    ...
    'smartaiBrowser' => array(
        ...
        'titleNpc'      => "SmartAI scripts: %s",
        'srcTypes'      => array(
            SmartAI::SRC_TYPE_CREATURE    => "Creature",
            SmartAI::SRC_TYPE_OBJECT      => "Gameobject",
            SmartAI::SRC_TYPE_AREATRIGGER => "Areatrigger",
            SmartAI::SRC_TYPE_ACTIONLIST  => "Timed action list"
        ),
        'colEntity'     => "Scripted entity",
        'colCount'      => "Rows",
        'colEvents'     => "Events",
        'colActions'    => "Actions",
        'guid'          => "guid %d"
    ...
    'waypointpath' => array(
        ...
        'titleNpc'     => 'Waypoint path #%1$d (%2$s)',
        'id'           => "ID",
        'kind'         => "Type",
        'kinds'        => ['Movement path', 'Escort path'],
        'source'       => "Source",
        'sources'      => ['Default path', 'Assigned by SmartAI'],
        'points'       => "Points",
    ...
    'legacyScript' => array(
        'srcTypes'      => array(
            ...
            LegacyScript::SRC_SPELL       => "Spell script #%d",
            LegacyScript::SRC_WAYPOINT    => "Waypoint script #%d",
            LegacyScript::SRC_QUEST_START => "Quest accept script #%d",
            LegacyScript::SRC_QUEST_END   => "Quest reward script #%d",
            LegacyScript::SRC_ESCORT_PATH => "Escort path #%d"
        ),
        'delay'         => "Delay",
        'action'        => "Action",
        'atPos'         => "At position",
        ...
        'effIndex'      => '(effect %1$d)',
        'noText'        => "Say nothing",
        'stringId'      => 'Say text #[b]%1$d[/b]',
        'cmd'           => array(
            'talk'           => 'Say %1$s',
            'emote'          => 'Play emote %1$s',
            'fieldSet'       => 'Set field [b]%1$d[/b] to [b]%2$d[/b]',
            'moveTo'         => 'Move to the position below over %1$s',
            'flagSet'        => 'Set flags %2$s on field [b]%1$d[/b]',
            'flagRemove'     => 'Remove flags %2$s from field [b]%1$d[/b]',
            'teleportTo'     => 'Teleport to map [b]%1$d[/b]',
            'questExplored'  => 'Credit the exploration objective of %1$s within [b]%2$d[/b] yd',
            'killCredit'     => 'Give kill credit for %1$s',
            'respawnObject'  => 'Respawn %1$s for %2$s',
            'summonCreature' => 'Summon %1$s for %2$s',
            'openDoor'       => 'Open %1$s for %2$s',
            'closeDoor'      => 'Close %1$s for %2$s',
            'activateObject' => "Activate the target object",
            'removeAura'     => 'Remove aura %1$s',
            'castSpell'      => 'Cast %1$s',
            'playSound'      => 'Play sound %1$s',
            'createItem'     => 'Create %2$dx %1$s',
            'despawnSelf'    => 'Despawn after %1$s',
            'loadPath'       => 'Start waypoint path #[b]%1$d[/b]',
            'callScript'     => 'Run script #[b]%1$d[/b] of script type [b]%2$d[/b] on the target',
            'kill'           => "Kill the target",
            'orientation'    => "Change orientation",
            'equip'          => 'Equip equipment template #[b]%1$d[/b]',
            'model'          => 'Change model to #[b]%1$d[/b]',
            'closeGossip'    => "Close the gossip window",
            'playMovie'      => 'Play movie #[b]%1$d[/b]',
            'movement'       => 'Set movement type [b]%1$d[/b] (%2$d)',
            'playAnimKit'    => 'Play anim kit #[b]%1$d[/b]',
            'unknown'        => 'Unknown script command [b]%1$d[/b] (%2$d, %3$d, %4$d)'
        )
    ),
    'areatrigger' => array(
    ...
    'gossip' => array(
        'notFound'          => "This gossip menu doesn't exist.",
        'menu'              => "Gossip menu #%d",
        'text'              => "Text",
        'textId'            => "Text ID",
        'chance'            => "Weight",
        ...
        'emotes'            => "Emotes",
        'emote'             => "Emote #%d",
        'emoteDelay'        => "after %dms",
        'fromBroadcastText' => "from broadcast text #%s",
        ...
        'marksPoi'          => "Marks the map at %s",
        'unnamedPoi'        => "point of interest #%d",
        'boxMoney'          => "Costs",
        'boxCoded'          => "Requires the answer to be typed out",
        'openedBy'          => "Opened by",
    ...
    'npc' => array(
        ...
        'seat'          => "Seat",
        'srcColumn'     => "Source",
        'srcSpellbook'  => "Spellbook",
        'srcSmartai'    => "SmartAI",
        'srcSpawnaura'  => "Spawn aura",
        'srcSpellclick' => "Spellclick",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'This achievement will be converted to <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> if you transfer to <span class="icon-%s">%s</span>.',
        'cat'           => array(
    ...
    'spell' => array(
        ...
        '_transfer'     => 'This spell will be converted to <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> if you transfer to <span class="icon-%s">%s</span>.',
        ...
        'cat'           => array(                           // as per menu in locale_enus.js
            ...
            -13 => ["Glyphs", [null, "Warrior", "Paladin", "Hunter", "Rogue", "Priest", "Death Knight", "Shaman", "Mage", "Warlock", null, "Druid"]],
            -11 => ["Proficiencies", [8 => "Armor", 6 => "Weapon", 10 => "Languages"]],
             ...
             -3 => ["Pet Skills", array(
                782 => "Ghoul",             270 => "Generic",           653 => "Bat",                   210 => "Bear",                      655 => "Bird of Prey",          211 => "Boar",
...
/* -316*/   "Underwater Walking",                   "Periodic Haste"
    ...
    'item' => array(
        ...
        'content'       => "Content",
        '_transfer'     => 'This item will be converted to <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> if you transfer to <span class="icon-%s">%s</span>.',
