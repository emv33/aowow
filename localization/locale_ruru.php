...
//      'noTarget'      => "[To others without a target]",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'Этот предмет превратится в <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
        'cat'           => array(
                1 => "Статистика",                                                   21 => "PvP",
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Этот предмет превратится в <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Цена",
        'content'       => "Материал",
        '_transfer'     => 'Этот предмет превратится в <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
