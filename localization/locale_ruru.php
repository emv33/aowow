...
//      'noTarget'      => "[To others without a target]",
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Этот предмет превратится в <a href="?spell=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a>, если вы перейдете за <span class="icon-%5$s">%6$s</span>.',
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Цена",
        'content'       => "Материал",
        '_transfer'     => 'Этот предмет превратится в <a href="?item=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a>, если вы перейдете за <span class="icon-%5$s">%6$s</span>.',
