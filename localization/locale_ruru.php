...
$lang = array(
    ...
    'meta' => array(
        'tags'          => array(
            ...
            'home'    => ['Инструмент сравнения предметов', 'Расчёт талантов', 'Расчёт умений питомцев', 'Профили персонажей'],
            'maps'    => ['Карты', 'Местности', 'Маркеры'],
            'compare' => ['Сравнить', 'Предметы', 'Комплекты', 'Значения характеристик']
        ),
        'description' => array(
            'genList'     => 'Все %s World of Warcraft в виде списка с возможностью фильтрования и поиска.',
            'genPage'     => '%s — %s в World of Warcraft.',
            'error'       => 'Страница, на которую вы попытались зайти, не существует.  По крайней мере, не в этом измерении. Ошибка 404.',
            'home'        => 'Информация о World of Warcraft, советы и инструменты для заданий, предметов, талантов, подземелий, рейдов и многого другого!',
            'changelog'   => 'История изменений, внесенных в «%s»',
            'npc'         => '%s — НИП %s.',
            'itemset'     => 'Набор предметов для %s с %d частями набора.',
            'pet'         => '%s — семейство %s в World of Warcraft. Они любят есть %s.',
            'quest'       => 'Задание%3$s из категории %1$s%2$d уровня.',
            'guild'       => '[%s of %s is guild (%s) with %d members.]',
            'arena-team'  => '[%s of %s is a %dv%3$d Arena Team.]',
            'profile'     => 'Профиль World of Warcraft персонажа %s: Уровень %d %s %s (%s-%s).'
        ),
        'inCategory'    => 'В категории "%s".',
        'eventEndsFmt'  => "'Завершится' d MMMM %s 'в' HH:mm.'", // intl
        'iconUsedBy'    => 'Иконка "%s" используется для %s.',
        'iconUnused'    => 'Иконка "%s" нигде не использована.',
        'setbonus'      => 'Имеются бонусы комплекта %s частей.',
        'npcFoundIn'    => 'Этот НИП может быть найден в следующих зонах: %s.',
        'objFoundIn'    => '%s  — объект в World of Warcraft, находится в %s.',
        'foundInExt'    => "еще %d зон",
        'petTraitPref'  => 'питомцев категории %s',
        'questReward'   => 'Награды %s.',
        'itemSourceMore'=> array(
            SRC_DROP           => 'Этот предмет добывается с %s.',                                  SRC_QUEST       => 'Этот предмет является наградой за задание %s.',
            SRC_VENDOR         => 'Этот предмет продаётся у %s.',                                   SRC_ACHIEVEMENT => 'Этот предмет является наградой за достижение %s.',
            SRC_DISENCHANTMENT => 'Этот предмет распыляется из %s.',                                SRC_FISHING     => 'Этот предмет вылавливается из %s.',
            SRC_GATHERING      => 'Этот предмет собирается из %s.',                                 SRC_MILLING     => 'Этот предмет получается при перемалывании %s.',
            SRC_MINING         => 'Этот предмет добывается из %s.',                                 SRC_PROSPECTING => 'Этот предмет добывается при просеивании %s.',
            SRC_PICKPOCKETING  => 'Этот предмет украден у %s.',                                     SRC_SALVAGING   => 'Этот предмет получен при разборке %s.',
            SRC_SKINNING       => 'Этот предмет получается при снятии шкуры с %s.'
        ),
        'itemSource'    => ['Это %s.', array(
            SRC_CRAFTED        => 'изготовлен',                                                     SRC_DROP        => 'добыт',
            SRC_PVP            => 'получен в PvP',                                                  SRC_QUEST       => 'наградой за задание',
            SRC_VENDOR         => 'продаётся у торговца',                                           SRC_REDEMPTION  => 'получен по акции',
            SRC_STARTER        => 'начальный предмет',                                              SRC_ACHIEVEMENT => 'наградой за достижение',
            SRC_DISENCHANTMENT => 'распылён',                                                       SRC_FISHING     => 'выловлен',
            SRC_GATHERING      => 'собран',                                                         SRC_MILLING     => 'перемолот',
            SRC_MINING         => 'добыт',                                                          SRC_PROSPECTING => 'просеян',
            SRC_PICKPOCKETING  => 'украден',                                                        SRC_SALVAGING   => 'разобран',
            SRC_SKINNING       => 'снят со шкуры'
        )],
        'itemCatDesc' => array(
            ITEM_CLASS_CONSUMABLE => '%s — %3$s%2$s.',                                                                      // name, itemLevel?, itemType
            ITEM_CLASS_CONTAINER  => '%s — %3$s %2$d-слотовая сумка.',                                                      // name, nSlots, bagType
            ITEM_CLASS_WEAPON     => 'Этот %s %s — предмет %d-го уровня.',                                                  // quality, weaponType, itemLevel
            ITEM_CLASS_GEM        => 'Это %2$s %3$s%1$s',                                                                   // itemLevel?, quality, color
            ITEM_CLASS_ARMOR      => 'Этот %s %s %d-го уровня подходит для слота "%s".',                                    // quality, armorType, itemlevel, equipSlot
            ITEM_CLASS_AMMUNITION => '%s могут наносить %.1f ед. урона в секунду.',                                         // name, dps
            ITEM_CLASS_TRADEGOOD  => '%s используется различными профессиями.',                                             // name
            ITEM_CLASS_KEY        => '%s  - ключ.',                                                                         // name
            ITEM_CLASS_GLYPH      => 'Это %s символ класса %s. Символы продаются на аукционе или создаются начертателями.', // glyphType, class
        )
    ),
    'main' => array(
        'name'          => "название",
    ...
    'game' => array(
        ...
        'copper'        => "%d |4медная монета:медные монеты:медных монет;",
        'silver'        => "%d |4серебряная:серебряные:серебряных;",
        'gold'          => "%d |4золотая:золотые:золотых;",

        'pvp'           => "PvP",
        'honorPoints'   => "Очки Чести",
        'arenaPoints'   => "Очки арены",
        'acvmtPoints'   => "Очки достижений",
        ...
        'pvpSources'    => array(
             42 => "Сезон арены 1",          62 => "Сезон арены 2",          71 => "Сезон арены 3",          80 => "Сезон арены 4",         157 => "Сезон арены 5",
            167 => "Сезон арены 6",         169 => "Сезон арены 7",         177 => "Сезон арены 8",         163 => "Турнир арены 2009"
        ),
        'languages'     => array(
...
//      'noTarget'      => "[To others without a target]",
    ...
    'gameObject' => array(
        ...
        'cat'           => array(
             0 => "Другое", 3 => "Контейнеры", 6 => "Ловушки", 9 => "Книги", 19 => "Почтовые ящики", 25 => "Рыболовные лунки",
            -5 => "Сундуки", -3 => "Травы", -4 => "Полезные ископаемые", -2 => "Задания", -6 => "Инструменты", -9 => "Интерактивные объекты"
        ),
        'type'          => array(                           // used for tooltip
             3 => "Контейнер",  6 => "", 9 => "Книга", 19 => "", 25 => "",
            -5 => "Сундук",  -3 => "Растение", -4 => "Полезное ископаемое", -2 => "Задание", -6 => "", -9 => ""
        ),
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'Этот предмет превратится в <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
        'cat'           => array(
                1 => "Статистика",                                                   21 => "PvP",
    ...
    'mail' => array(
        ...
        'mailDelivery'  => 'Вы получите <a href="?mail=%d">это письмо</a>%s%s',
    ...
    'pet'      => array(
        ...
        'food'          => [null, "Мясо", "Рыба", "Сыр", "Хлеб", "Грибы", "Фрукты", "Сырое мясо", "Сырая рыба"]
    ),
    'faction' => array(
        'id'            => "Фракция ID: ",
        ...
        'cat'           => array(
            ...
            0    => "Другое",                        949 => "Тестовая фракция 1",        948 => "Тестовая фракция 2"
        )
    ),
    'itemset' => array(
        'id'            => "Комплект ID: ",
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Этот предмет превратится в <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
        ...
        'cat'           => array(
              7 => ["Способности"],
            -13 => ["Символы", [null, "Воин", "Паладин", "Охотник", "Разбойник", "Жрец", "Рыцарь смерти", "Шаман", "Маг", "Чернокнижник", null, "Друид"]],
            -11 => ["Умения", [8 => "Броня", 10 => "Языки", 6 => "Оружие"]],
             -4 => ["Классовые навыки"],
             -2 => ["Таланты"],
             -6 => ["Спутники"],
             -5 => ["Транспорт", [1 => "Наземные средства передвижения", 2 => "Летающие средства передвижения", 3 => "Разное"]],
             -3 => ["Способности питомцев", array(
                782 => "Вурдалак",          270 => "Общий",             211 => "Вепрь",                 208 => "Волк",                      654 => "Гиена",                 787 => "Гончая Недр",
             ...
             -7 => ["Таланты питомцев", [411 => "Хитрость", 410 => "Свирепость", 409 => "Упорство"]],
             11 => ["Профессии", array(
                171 => ["Алхимия"],
                164 => ["Кузнечное дело", [9788 => "Школа брони", 9787 => "Школа оружейников", 17041 => "Мастер школы топора", 17040 => "Мастер школы молота", 17039 => "Мастер ковки клинков"]],
                333 => ["Наложение чар"],
                202 => ["Инженерное дело", [20219 => "Гномская механика", 20222 => "Гоблинская механика"]],
                182 => ["Травничество"],
                773 => ["Начертание"],
                755 => ["Ювелирное дело"],
                165 => ["Кожевничество", [10656 => "Драконья чешуя", 10658 => "Стихия", 10660 => "Племена"]],
                186 => ["Горное дело"],
                393 => ["Снятие шкур"],
                197 => ["Портняжное дело", [26798 => "Портняжное дело изначальной луноткани", 26801 => "Портняжное дело тенеткани", 26797 => "Портняжное дело чародейского огня"]]
            )],
              9 => ["Вторичные навыки", [185 => "Кулинария", 129 => "Первая помощь", 356 => "Рыбная ловля", 762 => "Верховая езда"]],
             -9 => ["Способности ГМ"],
             -8 => ["Способности НИП"],
              0 => ["Разное"]
        ),
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "Цена",
        'content'       => "Материал",
        '_transfer'     => 'Этот предмет превратится в <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>, если вы перейдете за <span class="icon-%s">%s</span>.',
        ...
        '_gemColors'    => ['Красные', 'Синие', 'Желтые', 'Фиолетовые', 'Зелёные', 'Оранжевые', 'Особые', 'Простые', 'Радужные'],
