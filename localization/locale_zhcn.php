...
//      'noTarget'      => "对别人并且不选择目标",
    ...
    'achievement' => array(
        ...
        'rfAvailable'   => "在服务器上可用：",
        '_transfer'     => '这个成就将被转换到<a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
        'cat'           => array(
                1 => "属性",                                                           21 => "PvP",
               81 => "光辉事迹",                                                         92 => "综合",
               95 => "PvP",                                                          96 => "任务",
    ...
    'spell' => array(
        ...
        '_collapseAll'  => "折叠全部",
        '_expandAll'    => "展开全部",
        '_transfer'     => '这个法术将被转换到<a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
        '_affected'     => "受影响法术：",
        '_seeMore'      => "[See more]",
        '_rankRange'    => "排名:&nbsp;%d&nbsp;-&nbsp;%d",
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "花费",
        'content'       => "内容",
        '_transfer'     => '这个物品将被转换到<a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
