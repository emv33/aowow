...
$lang = array(
    ...
    'game' => array(
        ...
        'pvpSources'    => array(
            42 => "竞技场赛季 1",         62 => "竞技场赛季 2",         71 => "竞技场赛季 3",         80 => "竞技场赛季 4",        157 => "竞技场赛季 5",
           167 => "竞技场赛季 6",        169 => "竞技场赛季 7",        177 => "竞技场赛季 8",        163 => "2009竞技场锦标赛"
        ),
        'languages'     => array(
...
//      'noTarget'      => "对别人并且不选择目标",
    ...
    'gossip' => array(
        ...
        'emote'             => "表情 #%d",
        'emoteDelay'        => "延迟 %d 毫秒",
        'fromBroadcastText' => "来自 broadcast text #%s",
        'emptyText'         => "该文本条目没有内容。",
        'emptyOption'       => "（无文本）",
    ...
    'gameObject' => array(
        ...
        'cat'           => array(
             0 => "其他",  3 => "容器",  6 => "陷阱",  9 => "书籍", 19 => "邮箱", 25 => "钓鱼点",
            -5 => "宝箱", -3 => "草药", -4 => "矿脉", -2 => "任务", -6 => "工具", -9 => "可交互目标"
        ),
        'type'          => array(                           // used for tooltip
             3 => "容器",  6 => "", 9 => "书籍", 19 => "", 25 => "",
            -5 => "宝箱", -3 => "草药", -4 => "矿脉", -2 => "任务", -6 => "", -9 => ""
        ),
    ...
    'achievement' => array(
        ...
        'rfAvailable'   => "在服务器上可用：",
        '_transfer'     => '这个成就将被转换到<a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
        'cat'           => array(
                1 => "属性",                                                           21 => "PvP",
               81 => "光辉事迹",                                                         92 => "综合",
               95 => "PvP",                                                          96 => "任务",
    ...
    'pet'      => array(
        ...
        'exotic'        => "异域的",
        'cat'           => ["狂野", "坚韧", "狡诈"],
        'food'          => [null, "肉", "鱼", "奶酪", "面包", "蘑菇", "水果", "生肉", "生鱼"]
    ),
    'faction' => array(
        'id'            => "阵营ID：",
        'notFound'      => "这个阵营不存在。",
    ...
    'spell' => array(
        ...
        '_collapseAll'  => "折叠全部",
        '_expandAll'    => "展开全部",
        '_transfer'     => '这个法术将被转换到<a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
        '_affected'     => "受影响法术：",
        '_seeMore'      => "[See more]",
        '_rankRange'    => "排名:&nbsp;%d&nbsp;-&nbsp;%d",
        ...
        'cat'           => array(
              7 => ["技能"],
            -13 => ["雕文", [null, "战士", "圣骑士", "猎人", "潜行者", "牧师", "死亡骑士", "萨满祭司", "法师", "术士", null, "德鲁伊"]],
            -11 => ["精通", [8 => "护甲", 6 => "武器", 10 => "语言"]],
             ...
             -3 => ["宠物能力", array(
                782 => "食尸鬼", 270 => "通用", 653 => "蝙蝠", 210 => "熊", 655 => "猛禽", 211 => "野猪",
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "花费",
        'content'       => "内容",
        '_transfer'     => '这个物品将被转换到<a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a>，如果你转移到<span class="icon-%s">%s</span>。',
