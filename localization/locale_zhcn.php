...
//      'noTarget'      => "对别人并且不选择目标",
    ...
    'spell' => array(
        ...
        '_collapseAll'  => "折叠全部",
        '_expandAll'    => "展开全部",
        '_transfer'     => '这个法术将被转换到<a href="?spell=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a>，如果你转移到<span class="icon-%5$s">%6$s</span>。',
        '_affected'     => "受影响法术：",
        '_seeMore'      => "[See more]",
        '_rankRange'    => "排名:&nbsp;%d&nbsp;-&nbsp;%d",
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'cost'          => "花费",
        'content'       => "内容",
        '_transfer'     => '这个物品将被转换到<a href="?item=%1$d" class="q%2$d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/tiny/%3$s.gif);background-image:image-set(url(STATIC_URL/images/wow/icons/tiny/%3$s.gif) 1x, url(STATIC_URL/images/wow/icons/tiny/%3$s@2x.gif) 2x)">%4$s</a>，如果你转移到<span class="icon-%5$s">%6$s</span>。',
