...
$lang = array(
    ...
    'game' => array(
        ...
        'copper'        => "%d cobre",                      // COPPER_AMOUNT
        'silver'        => "%d plata",                      // SILVER_AMOUNT
        'gold'          => "%d oro",                        // GOLD_AMOUNT

        'pvp'           => "JcJ",
        'honorPoints'   => "Puntos de Honor",
        'arenaPoints'   => "Puntos de arena",
        'acvmtPoints'   => "Puntos por logros",
...
/* 60*/     SmartEvent::EVENT_UPDATE                  => ['(%11$s)?Después de %11$s:Instantáneamente;', 'Repetir cada %s'],
            ...
            SmartEvent::EVENT_GOSSIP_SELECT           => ['Seleccionando opción de charla:[br][url=?gossip=%1$d](%11$s)?[span class="%12$s"]%11$s[/span]:Menú #[b]%1$d[/b] - Opción #[b]%2$d[/b];[/url]', ''],
...
/* 90*/     SmartAction::ACTION_SET_UNIT_FIELD_BYTES_1             => ['Establecer UnitFieldBytes1 %11$s para #target#.', ''],
            ...
            SmartAction::ACTION_SEND_GOSSIP_MENU                   => ['Mostrar [url=?gossip=%1$d]entrada de chismes #[b]%1$d[/b][/url] / ID de texto #[b]%2$d[/b].', ''],
...
/*130*/     SmartAction::ACTION_SCENE_CANCEL                       => null,
            SmartAction::ACTION_SPAWN_SPAWNGROUP                   => ['Spawn the group [b]%11$s[/b](%12$s)? [small class=q0]— %12$s[/small]:;%13$s', 'Enfriamiento: %s'],
            SmartAction::ACTION_DESPAWN_SPAWNGROUP                 => ['Despawn the group [b]%11$s[/b](%12$s)? [small class=q0]— %12$s[/small]:;%13$s', 'Enfriamiento: %s'],
...
//      'noTarget'      => "Para otros sin un objetivo",
    ...
    'gossip' => array(
        'notFound'          => "Este menú de rumores no existe.",
        'menu'              => "Menú de rumores #%d",
        'text'              => "Texto",
        'textId'            => "ID de texto",
        'chance'            => "Peso",
        'condition'         => "Condición",
        ...
        'emote'             => "Emote #%d",
        'emoteDelay'        => "tras %dms",
        'fromBroadcastText' => "de broadcast text #%s",
        'emptyText'         => "Esta entrada de texto no tiene contenido.",
        ...
        'boxMoney'          => "Cuesta",
        'boxCoded'          => "Requiere escribir la respuesta",
    ...
    'npc' => array(
        ...
        'seat'          => "Asiento",
        'srcColumn'     => "Fuente",
        'srcSpellbook'  => "Grimorio",
        'srcSmartai'    => "SmartAI",
        'srcSpawnaura'  => "Aura de aparición",
        'srcSpellclick' => "Hechizo al clic",
        'accessory'     => "Accesorio",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'Este logro será convertido a <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
        'cat'           => array(
    ...
    'mail' => array(
        ...
        'attachment'    => "Adjunto",
        'mailDelivery'  => 'Usted recibirá <a href="?mail=%d">esta carta</a>%s%s',
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Este hechizo será convertido a <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
        '_affected'     => "Hechizos affectados: ",
        '_seeMore'      => "Más información",
        '_rankRange'    => "Rango:&nbsp;%d&nbsp;-&nbsp;%d",
        '_showXmore'    => "Mostrar %d más",
        'casterAura'    => "Aura del lanzador",
        'targetAura'    => "Aura del objetivo",
        ...
        'cat'           => array(
              7 => ["Habilidades"],
            -13 => ["Glifos", [null, "Guerrero", "Paladín", "Cazador", "Pícaro", "Sacerdote", "Caballero de la Muerte", "Chamán", "Mago", "Brujo", null, "Druida"]],
            -11 => ["Habilidades", [6 => "Armas", 8 => "Armadura", 10 => "Lenguas"]],
             ...
             -3 => ["Habilidades de mascota", array(
                782 => "Necrófago",         270 => "Genérico",          766 => "Acechador deformado",   203 => "Araña",                     655 => "Ave rapaz",             785 => "Avispa",
...
/* -316*/   "Caminar bajo el agua",                                     "Celeridad periódica"
    ...
    'item' => array(
        ...
        'cost'          => "Coste",
        'content'       => "Contenido",
        '_transfer'     => 'Este objeto será convertido a <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.webp)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
