...
//      'noTarget'      => "Para otros sin un objetivo",
    ...
    'achievement' => array(
        ...
        '_transfer'     => 'Este logro será convertido a <a href="?achievement=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
        'cat'           => array(
    ...
    'spell' => array(
        ...
        '_transfer'     => 'Este hechizo será convertido a <a href="?spell=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
...
/* -316*/   "Caminar bajo el agua",                                     "Celeridad periódica"
    ...
    'item' => array(
        ...
        'cost'          => "Coste",
        'content'       => "Contenido",
        '_transfer'     => 'Este objeto será convertido a <a href="?item=%d" class="q%d icontiny tinyspecial" style="background-image:url(STATIC_URL/images/wow/icons/%s.png)">%s</a> si lo transfieres a la <span class="icon-%s">%s</span>.',
