...
?>
                ...
                <table class="grid" id="spelldetails">
                    ...
                    <tr>
                        ...
                        <td><?=$this->range.' <small>('.$this->rangeName.')</small>';?></td>
                    </tr>
                    <tr>
...
<?php
    echo Lang::concat($this->casterAura, callback: function($x, $neg) {
        return Lang::main($neg ? 'disallowed' : 'required', ['<div style="display:inline-block; line-height: 2.0em;"><a href="?spell='.$x[0].'"><span class="iconsmall"><ins style="'.Util::iconBg($x[1], 'small').'"></ins><del></del></span>'.$x[2].'</a></div>']);
    });
?>
                        </td>
                    </tr>
...
?>
                            ...
                            <small><a href="?spell=<?=$si;?>" class="icontiny"><img src="<?=$this->gStaticUrl;?>/images/wow/icons/tiny/<?=$ic;?>.gif" srcset="<?=Util::iconSrcset($ic);?>" align="absmiddle">
