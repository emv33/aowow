...
<?php
    ...
    $this->brick('pageTemplate', ['fiQuery' => $this->fiMenuExtension, 'fiMenuItem' => [107]]);
?>

            <div id="fi" style="display: <?=($this->filter->query ? 'block' : 'none'); ?>;">
                <form action="?filter=encounters" method="post" name="fi" onsubmit="return fi_submit(this)" onreset="return fi_reset(this)">
                    <div class="text">
...
?>
                    ...
                    <table>
                        ...
                        <tr>
                            <td><?=$this->ucFirst(Lang::encounter('lastBoss')).Lang::main('colon'); ?></td>
                            <td colspan="2"><input type="checkbox" name="lb" value="1" <?=($f['lb'] ?? null ? 'checked="checked" ' : ''); ?>/></td>
                        </tr>
                    </table>
