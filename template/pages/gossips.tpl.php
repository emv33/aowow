...
<?php
    ...
    $this->brick('pageTemplate', ['fiQuery' => $this->fiMenuExtension, 'fiMenuItem' => [104]]);
?>

            <div id="fi" style="display: <?=($this->filter->query ? 'block' : 'none'); ?>;">
                <form action="?filter=gossips" method="post" name="fi" onsubmit="return fi_submit(this)" onreset="return fi_reset(this)">
                    <div class="text">
...
?>
                    ...
                    <div class="rightpanel">
                        <div style="float: left"><?=Lang::gossip('optionType'); ?></div>
                        ...
                        <div class="clear"></div>
                        <select name="ty[]" size="10" multiple="multiple" class="rightselect">
<?=$this->makeOptionsList(Lang::gossip('optionTypes'), $f['ty'] ?? [], 28); ?>
                        </select>
                    </div>
                    <table>
                        <tr>
                            <td><?=$this->ucFirst(Lang::gossip('option')).Lang::main('colon'); ?></td>
                            <td colspan="2">
                                <table><tr>
